...
export async function POST(req) {
    ...
    let prompt = `You are a curiosity guide that helps learners explore themes through questions. Given a conversation history, generate the next step in their exploration.
