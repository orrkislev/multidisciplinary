    ...
    return (
        <div className="group bg-white rounded-lg shadow-md p-4 w-72 flex flex-col relative">
            <button
                ...
                className="absolute top-2 right-2 opacity-0 group-hover:opacity-100 transition-opacity duration-150 bg-red-100 hover:bg-red-100 text-red-600 hover:text-red-600 rounded-full p-1 z-10"
            ...
            {list.description && (
                <div className="text-xs text-red-500 mb-2">{list.description}</div>
            )}
