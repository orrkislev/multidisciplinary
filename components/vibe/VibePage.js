...
const Title = styled.h1`text-6xl text-gray-800 uppercase font-serif text-center select-none`;
...
export default function VibePage(){
	...
	return (
		<Container>
            <div className='grid grid-cols-4 grid-rows-2 mb-16 gap-8'>
                {titleText.split(' ').map((word, i) => (
                    <Title key={i}>{word}</Title>
                ))}
            </div>
			{/* <Title>JUST TELL ME HOW YOU WANT TO FEEL</Title> */}
